...
class TestResultWriter:
    ...
    def test_write_run(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            run_id, results_file, summary = writer.write_run("test-config", trials)
    ...
    def test_results_jsonl_format(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            run_id, results_file, _ = writer.write_run("test-config", trials)
    ...
    def test_load_run(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            run_id, _, _ = writer.write_run("test-config", trials)
